    ...
    <>
      <SuperCard className="section1" ref={firstCard}>
        ...
        <Flex flexColumn gap={2}>
          <SubTitle>
            1.1: Interfaces d'inscription de l'application Cipecmeal
          </SubTitle>
          <ImageFrame>
            <img
      ...
      <SuperCard className="section2" ref={secondCard}>
        <SubTitle>
          1.2: Interface de connexion de l'application Cipecmeal
        </SubTitle>
        <ImageFrame>
          <img src={CipecmealLogin} alt="Login Utilisateur" width="100%" />
        </ImageFrame>
      </SuperCard>
      ...
      <SuperCard className="section3" ref={thirdCard}>
        <SubTitle>
          1.3: Gestionnaire des comptes enregistrés (admin seulement)
        </SubTitle>
        <ImageFrame>
          <img
      ...
      <SuperCard className="section4" ref={fourthCard}>
        <SubTitle>
          1.4: Interface "Mon Compte" de l'application Cipecmeal
        </SubTitle>
        <ImageFrame>
          <img
